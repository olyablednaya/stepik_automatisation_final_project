#файл для тестов дсвязаных со страницей товара
...
#в уроках тесты с параметризацией советовали закоментить, но их прохожедение можно проверить так:

#раскоментировать параметризацию ниже и передать
#link аргументом в test_guest_can_add_product_to_basket + закоментить link в теле метода
